...
func TestHandlePostResourceExecSuccess(t *testing.T) {
	...
	mockExecFunc := func(ctx context.Context, namespace, name string, command []string, container string, timeout time.Duration) (*unstructured.Unstructured, error) {
	...
	request.Params.Name = "post_resource"
...
func TestNewPostResourceTool(t *testing.T) {
	...
	assert.Equal(t, "post_resource", tool.Name)
